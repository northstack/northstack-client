...
use NorthStack\NorthStackClient\SappTemplate;
...
class NewCreateCommand extends Command
{
    ...
    {
        parent::__construct('app:new-create');
        $this->api = $api;
        $this->orgs = $orgs;
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $templ = new SappTemplate($options['type'], $nsdir);
        $templ->createSkeleton($args['name'], []);
        exit;
